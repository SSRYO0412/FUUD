...
struct AthleticDetailView: View {
    ...
    private let categoryId: CategoryId = .performance
    ...
    var body: some View {
        ScrollView {
            VStack(spacing: VirgilSpacing.lg) {
                ...
                VStack(alignment: .leading, spacing: VirgilSpacing.md) {
                    ...
                    Text("あなたの運動能力スコアは優秀です。適切なトレーニングと栄養補給が、パフォーマンスの向上に寄与しています。引き続き現在の習慣を維持することで、長期的な運動能力の維持が期待できます。")  // AIコメント、API連携後に実データ使用
                ...
                VStack(alignment: .leading, spacing: VirgilSpacing.md) {
                    ...
                    ScoreTrendGraph(scores: [81, 83, 85, 86, 88, 89])  // 過去6ヶ月のスコア
                }
                .padding(VirgilSpacing.md)
                .liquidGlassCard()
        ...
        .toolbar { // NavigationBarに全体共有ボタン追加
