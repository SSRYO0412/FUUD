...
struct AuthenticationView: View {
    ...
    var body: some View {
        ...
        .alert("メッセージ", isPresented: .constant(!cognitoService.message.isEmpty && !cognitoService.mfaRequired && !cognitoService.mfaSetupRequired && !cognitoService.newPasswordRequired)) {
            Button("OK") {
