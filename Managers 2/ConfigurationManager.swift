    ...
    struct AWSCredentialsConfig {
        ...
        static var current: AWSCredentialsConfig {
            ...
            return AWSCredentialsConfig(
                accessKey: ProcessInfo.processInfo.environment["AWS_ACCESS_KEY_ID"] ?? "AKIAIOSFODNN7EXAMPLE",
                secretKey: ProcessInfo.processInfo.environment["AWS_SECRET_ACCESS_KEY"] ?? "wJalrXUtnFEMI/K7MDENG/bPxRfiCYEXAMPLEKEY",
                region: "ap-northeast-1"
            )
        }
    }
